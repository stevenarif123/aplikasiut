...
<html lang="en" data-bs-theme="auto">
  <head><script src="./assets/js/color-modes.js"></script>
    ...
    <meta name="author" content="Hermanto Steven Lisu Allo Arif">
...
<main class="form-signin w-100 m-auto">
  <form action="login.php" method="post">
    ...
    <div class="form-floating">
      <input type="text" class="form-control" name="username" id="username" value="<?php echo $username; ?>" placeholder= "steven">
    ...
    <button class="btn btn-primary w-100 py-2" type="submit" name="submit">Masuk</button>
    <?php
    if ($error != "") {
