...
if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO mabawebsite (nama_lengkap, tempat_lahir, tanggal_lahir, nama_ibu_kandung, nik, jurusan, nomor_hp, agama, jenis_kelamin, status_perkawinan) VALUES ('$nama_lengkap', '$tempat_lahir', '$tanggal_lahir', '$nama_ibu_kandung', '$nik', '$jurusan', '$nomor_hp', '$agama', '$jenis_kelamin', '$status_perkawinan')";
...
<head>
        ...
        <main class="flex-shrink-0">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white py-3">
                <div class="container px-5">
                    <a class="navbar-brand" href="index.html"><span class="fw-bolder text-primary">SALUT TANA TORAJA</span></a>
    ...
    <div class="container mt-5">
        ...
        <form id="form-daftar" action="" method="post" class="mt-5 mx-auto" style="width: 80%;"> <!-- Lebar form diperbesar menjadi 80% -->
        <table style="width: 100%;" class="navbar navbar-expand-lg navbar-light bg-white py-3"> <!-- Lebar tabel diperbesar menjadi 100% -->
            <tr>
