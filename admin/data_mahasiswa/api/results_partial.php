  ...
  <div class="d-flex justify-content-center mt-4">
    <nav aria-label="Page navigation">
      <ul class="pagination flex-wrap">
        <?php if ($page > 1) { ?>
          <li class="page-item">
            <a class="page-link" href="?page=<?php echo $page - 1; ?>&limit=<?php echo $limit; ?>&search_column=<?php echo $search_column; ?>&keyword=<?php echo $keyword; ?>" aria-label="Previous">
        ...
        <?php for ($i = 1; $i <= $total_pages; $i++) { ?>
          <li class="page-item <?php echo $i == $page ? 'active' : ''; ?>">
            <a href="?page=<?php echo $i; ?>&limit=<?php echo $limit; ?>&search_column=<?php echo $search_column; ?>&keyword=<?php echo $keyword; ?>" class="page-link">
              <?php echo $i; ?>
            </a>
          </li>
        <?php } ?>
        <?php if ($page < $total_pages) { ?>
          <li class="page-item">
            <a class="page-link" href="?page=<?php echo $page + 1; ?>&limit=<?php echo $limit; ?>&search_column=<?php echo $search_column; ?>&keyword=<?php echo $keyword; ?>" aria-label="Next">
