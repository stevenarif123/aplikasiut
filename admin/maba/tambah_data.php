...
<body>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const jurusanSMKInput = document.getElementById("jurusan_smk");
            ...
            function handleLayananPaket() {
                ...
                if (selectedJurusan === 'PGSD' || selectedJurusan === 'PAUD') {
            ...
            tahunIjazahInput.addEventListener('input', function() {
                const tahunIjazah = parseInt(this.value);
                if (tahunIjazah > 2014) {
                    document.getElementById("nisn").classList.remove("hidden");
                } else {
                    document.getElementById("nisn").classList.add("hidden");
                }
            });
