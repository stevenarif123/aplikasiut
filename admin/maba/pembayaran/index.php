            ...
            <div class="modal-body">
                <form id="editForm">
                    ...
                    <div class="form-group" id="admisiGroup">
                        ...
                        <input type="text" class="form-control" id="admisi">
                    ...
                    <div id="tagihanGroup">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="almamater" value="200000">
                        </div>
                        <div class="form-group">
...
$(document).ready(function() {
    ...
    $('#whatsappModal').on('show.bs.modal', function (event) {
        ...
        message += `SPP : Rp. ${spp}\nSALUT : Rp. ${salut}\nAlmamater : Rp. ${almamater}\n\n*TOTAL* : *Rp. ${total}*\n\n`;
        
        if (pembayaran > 0) {
            message += `*Terbayar* : Rp. ${pembayaran}\n`;
        }
        
        if (sisa != 0) {
            message += `*Kurang/Lebih* : Rp. ${sisa}\n\n`;
        }
